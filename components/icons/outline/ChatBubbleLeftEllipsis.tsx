...
// Icon: ChatBubbleLeftEllipsis (outline)
/**
...
type ChatBubbleLeftEllipsisProps = IconBaseProps;

export default function ChatBubbleLeftEllipsis({
	size = 45,
	color = "currentColor",
	className = "",
	strokeWidth = "1.5",
	...rest
}: ChatBubbleLeftEllipsisProps) {
	return (
		<svg

...
// Icon: ArrowRightOnRectangle (outline)
/**
...
type ArrowRightOnRectangleProps = IconBaseProps;

export default function ArrowRightOnRectangle({
	size = 45,
	color = "currentColor",
	className = "",
	strokeWidth = "1.5",
	...rest
}: ArrowRightOnRectangleProps) {
	return (
		<svg

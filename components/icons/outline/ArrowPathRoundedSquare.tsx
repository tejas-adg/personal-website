...
// Icon: ArrowPathRoundedSquare (outline)
/**
...
type ArrowPathRoundedSquareProps = IconBaseProps;

export default function ArrowPathRoundedSquare({
	size = 45,
	color = "currentColor",
	className = "",
	strokeWidth = "1.5",
	...rest
}: ArrowPathRoundedSquareProps) {
	return (
		<svg

...
// Icon: DocumentMagnifyingGlass (outline)
/**
...
type DocumentMagnifyingGlassProps = IconBaseProps;

export default function DocumentMagnifyingGlass({
	size = 45,
	color = "currentColor",
	className = "",
	strokeWidth = "1.5",
	...rest
}: DocumentMagnifyingGlassProps) {
	return (
		<svg

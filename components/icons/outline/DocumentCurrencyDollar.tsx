...
// Icon: DocumentCurrencyDollar (outline)
/**
...
type DocumentCurrencyDollarProps = IconBaseProps;

export default function DocumentCurrencyDollar({
	size = 45,
	color = "currentColor",
	className = "",
	strokeWidth = "1.5",
	...rest
}: DocumentCurrencyDollarProps) {
	return (
		<svg

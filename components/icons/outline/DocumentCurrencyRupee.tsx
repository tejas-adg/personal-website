...
// Icon: DocumentCurrencyRupee (outline)
/**
...
type DocumentCurrencyRupeeProps = IconBaseProps;

export default function DocumentCurrencyRupee({
	size = 45,
	color = "currentColor",
	className = "",
	strokeWidth = "1.5",
	...rest
}: DocumentCurrencyRupeeProps) {
	return (
		<svg

...
// Icon: DocumentCurrencyBangladeshi (outline)
/**
...
type DocumentCurrencyBangladeshiProps = IconBaseProps;

export default function DocumentCurrencyBangladeshi({
	size = 45,
	color = "currentColor",
	className = "",
	strokeWidth = "1.5",
	...rest
}: DocumentCurrencyBangladeshiProps) {
	return (
		<svg

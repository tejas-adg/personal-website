...
// Icon: ClipboardDocumentCheck (outline)
/**
...
type ClipboardDocumentCheckProps = IconBaseProps;

export default function ClipboardDocumentCheck({
	size = 45,
	color = "currentColor",
	className = "",
	strokeWidth = "1.5",
	...rest
}: ClipboardDocumentCheckProps) {
	return (
		<svg

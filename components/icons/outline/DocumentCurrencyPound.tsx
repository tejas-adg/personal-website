...
// Icon: DocumentCurrencyPound (outline)
/**
...
type DocumentCurrencyPoundProps = IconBaseProps;

export default function DocumentCurrencyPound({
	size = 45,
	color = "currentColor",
	className = "",
	strokeWidth = "1.5",
	...rest
}: DocumentCurrencyPoundProps) {
	return (
		<svg

...
// Icon: ArrowDownOnSquareStack (outline)
/**
...
type ArrowDownOnSquareStackProps = IconBaseProps;

export default function ArrowDownOnSquareStack({
	size = 45,
	color = "currentColor",
	className = "",
	strokeWidth = "1.5",
	...rest
}: ArrowDownOnSquareStackProps) {
	return (
		<svg

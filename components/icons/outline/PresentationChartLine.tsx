...
// Icon: PresentationChartLine (outline)
/**
...
type PresentationChartLineProps = IconBaseProps;

export default function PresentationChartLine({
	size = 45,
	color = "currentColor",
	className = "",
	strokeWidth = "1.5",
	...rest
}: PresentationChartLineProps) {
	return (
		<svg

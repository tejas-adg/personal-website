...
// Icon: ChatBubbleOvalLeftEllipsis (outline)
/**
...
type ChatBubbleOvalLeftEllipsisProps = IconBaseProps;

export default function ChatBubbleOvalLeftEllipsis({
	size = 45,
	color = "currentColor",
	className = "",
	strokeWidth = "1.5",
	...rest
}: ChatBubbleOvalLeftEllipsisProps) {
	return (
		<svg
